package com.ls.weixin.mp.handler;
...
import com.ls.core.utils.RegexUtils;
import com.ls.member.entity.UserEntity;
import com.ls.weixin.feign.MemberServiceFeign;
import com.ls.weixin.mp.builder.TextBuilder;
...
public class MsgHandler extends AbstractHandler {
	// 用户发送手机验证码提示
	@Value("${ls.weixin.registration.code.message}")
	private String registrationCodeMessage;
	// 默认用户发送验证码提示
	@Value("${ls.weixin.default.registration.code.message}")
